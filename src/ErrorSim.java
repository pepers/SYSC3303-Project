...
public class ErrorSim {
   ...
   public void ForwardPacket()
   {
      ...
      for(;;) { // loop forever
         ...
         // Call runnable object to open connection to server.
    	 DatagramSocket serverSocket = sendReceiveSocket;
    	 Runnable serverConnection = new serverConnection(sendPacket,sendReceiveSocket);
 ...
 class serverConnection implements Runnable
 {
	 ...
	 public serverConnection (DatagramPacket sendPacket, DatagramSocket sendReceiveSocket)
	 {
